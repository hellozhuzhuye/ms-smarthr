...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "smart.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "smart.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "smart.mail.routing.key";
}